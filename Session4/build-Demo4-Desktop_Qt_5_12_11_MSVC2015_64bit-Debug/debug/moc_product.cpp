...
QT_MOC_LITERAL(1, 8, 10), // "newProduct"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 8) // "Product*"

    },
    "Product\0newProduct\0\0Product*"
};
...
void Product::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newProduct((*reinterpret_cast< Product*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Product::*)(Product * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Product::newProduct)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Product::newProduct(Product * _t1)
{
